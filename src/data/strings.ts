...
export const UIStrings = {
  ...
  preference_enable_sound_summary: 'Disabling sound may improve performance.',
  preference_configure_controls: 'Configure Controls',
  preference_enable_click_attack: 'Click Attack',
  preference_enable_click_attack_summary: 'Tap screen to attack.',
  preference_enable_screen_controls: 'On-Screen Controls',
  preference_enable_screen_controls_summary: 'Displays movement pad and buttons on screen.',
  preference_movement_sensitivity: 'Motion Sensitivity',
  preference_movement_sensitivity_summary: 'Adjusts the sensitivity of the controls.',
